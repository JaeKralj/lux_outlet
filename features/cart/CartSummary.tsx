...
export default function CartSummary() {
  ...
  return (
    <section
      ...
      className='mt-5 rounded-lg border-2 border-gray-200 bg-slate-950 shadow px-4 py-6 dark:border-gray-900 dark:bg-black sm:p-6 lg:col-span-3 lg:mt-0 lg:p-8'
    >
